...
class InstructionsView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Press P to pause the game", constants.SCREEN_WIDTH / 2, constants.SCREEN_HEIGHT - 450, arcade.color.WHITE, font_size=16, anchor_x="center", font_name="Kenney Future")
