...
class HomeView(arcade.View):
    ...
    def on_show(self):
        ...
        play_button = arcade.gui.UITextureButton(x=0, y=0, texture=arcade.load_texture('astro_flight/game/images/play.png'), texture_hovered=arcade.load_texture('game/images/play_hovered.png'), texture_pressed=arcade.load_texture('game/images/play_pressed.png'), scale=constants.BUTTON_SCALING)
